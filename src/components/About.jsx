...
function About() {
    ...
    return (
        <section className="bg-success d-flex flex-column justify-content-evenly bg-gradient text-white w-100 h-75">
                <h1 className="ms-5">About Me</h1>
                <p className="lead mb-0 ms-5">
                ...
                <p className="ms-5">
                    In my free time, I read literature, write philosophy, and most importantly, play video games.
                </p>
